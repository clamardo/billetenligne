...
| `services/api` — three surfaces, middleware, every route | ✅ 304 tests + 467 smoke checks |
...
dart run tool/check_layers.dart                 # onion dependency rule, 428 files
...
**1,507 tests in total**, plus the smoke checks, the schema guarantees, the
