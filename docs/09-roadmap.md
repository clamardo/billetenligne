...
735 tests · 167 smoke checks · 30 executed schema guarantees · 141 further tests against real Postgres, and 10 against real Azurite.
...
**1. Phone as the second sign-in channel, and a per-IP limit on codes.**
