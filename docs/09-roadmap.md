...
828 tests · 199 smoke checks · 34 executed schema guarantees · 193 further tests against real Postgres, and 10 against real Azurite.
...
- ⬜ **Disruption — protection, and the passenger's own choice** (`08-disruption.md` §2.2 options ③ and ⑤, §3.2, §5) — a standing inter-operator agreement with settlement through our ledger, which is what already happens informally at Congolese gares in cash and with arguments; and letting the passengers choose between the options themselves instead of a dispatcher choosing for them
