...
./tool/integration.sh                    # 462 tests on real Postgres, incl. the worker
...
462 further tests against real Postgres and 10 against real Azurite. The smoke run now includes the *typed client* against the running
