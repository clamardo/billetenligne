...
cd apps/scanner && flutter test          # 42 scanner tests, incl. a manifest off the wire
...
**1,408 tests in total**, plus 445 smoke checks, 44 executed schema guarantees,
