...
**Updated:** 2026-08-13 · after commit *A road can be sold in pieces, and the operator names their price*
...
./tool/integration.sh                    # 450 tests on real Postgres, incl. the worker
...
450 further tests against real Postgres and 10 against real Azurite. The smoke run now includes the *typed client* against the running
