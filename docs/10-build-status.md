...
**Updated:** 2026-08-13 · after commit *The seat stops being told what it is, and starts being asked*
...
./tool/integration.sh                    # 455 tests on real Postgres, incl. the worker
./tool/smoke_api.sh                      # 387 checks, incl. the Dart client
...
**1,336 tests in total**, plus 387 smoke checks, 41 executed schema guarantees,
455 further tests against real Postgres and 10 against real Azurite. The smoke run now includes the *typed client* against the running
