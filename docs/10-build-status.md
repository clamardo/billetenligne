...
dart test packages/bel_domain packages/bel_localization \
         packages/bel_contracts packages/bel_crypto     # 575 tests
...
./tool/integration.sh                    # 442 tests on real Postgres, incl. the worker
...
**1,322 tests in total**, plus 374 smoke checks, 40 executed schema guarantees,
442 further tests against real Postgres and 10 against real Azurite. The smoke run now includes the *typed client* against the running
